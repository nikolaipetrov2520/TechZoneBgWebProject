namespace TechZoneBgWebProject.Web.Areas.Identity.Pages.Account.Manage
{
    ...
    public partial class EmailModel : PageModel
    {
        ...
        public class InputModel
        {
            [Required]
            [EmailAddress]
            [Display(Name = "Въведете вашият Email")]
        ...
        public async Task<IActionResult> OnPostChangeEmailAsync()
        {
            ...
            if (this.Input.NewEmail != email)
            {
                ...
                user.NormalizedEmail = this.Input.NewEmail.ToUpper();
